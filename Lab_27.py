...
class AmericanExpressCard(CreditCardBuilder):
    def __init__(self):
        super(AmericanExpressCard, self).__init__()
        self._credit_card = super(AmericanExpressCard, self).credit_card

    def bank_name_func(self) -> str:
        self._credit_card.bank = 'American Express'
        return self._credit_card.bank

    def card_limit_func(self) -> int:
        self._credit_card.card_limit = 20000
...
class VisaCard(CreditCardBuilder):
    ...
    def __init__(self):
        super(VisaCard, self).__init__()
        self._credit_card = super(VisaCard, self).credit_card

    def bank_name_func(self) -> str:
        self._credit_card.bank = "Garanti Bankası"
        return self._credit_card.bank

    def card_limit_func(self) -> int:
        self._credit_card.card_limit = 30000
        return self._credit_card.card_limit
